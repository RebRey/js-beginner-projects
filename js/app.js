...
function changeColors() {
  ...
  document.getElementsByClassName("project-1-container")[0].style.background =
    colors[project1Index++];

  if (project1Index > colors.length - 1) project1Index = 0;
}
...
function changeHexColor() {
  ...
  document.getElementsByClassName("project-2-container")[0].style.background =
    "#" + hexcode;
}
